...
function getSupply() {
  var preSupply = (8261391.897); //supply as of block 283510
  var supplyBlockNum = (48500);
  var minedBlocks = currBlock - supplyBlockNum;
  var coinsMined = minedBlocks * 47.5; // appx # of blocks x block reward = coins coinsMined
